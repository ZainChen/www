...
?>
            <tr>
              ...
              <td class="td_revise_ji">
                <a id="mdy" class="mdy" href="?id=<?php echo $row->id; ?>&txt_keyword=<?php echo $keyword ?>">修改</a> |
                <div id="delbtn<?php echo $i ?>" class="delbtn">删除</div>
                <div id="delyn<?php echo $i ?>" class="delyn">
                  <a id="dely" class="del" href="del_movie.php?id=<?php echo $row->id; ?>&txt_keyword=<?php echo $keyword ?>">是</a>
                  <div id="deln<?php echo $i ?>" class="deln">否</div>
                </div>
              </td>
            </tr>
<?php
