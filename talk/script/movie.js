...
var delbtnNum = 1;
while(1) {
  var delbtn = document.getElementById("delbtn"+delbtnNum);
  if(delbtn == null) {
    break;
  }
  delbtn.onclick = (function(i) {
    return function() {
      var delyn = document.getElementById("delyn"+i);
      delyn.style.display = "inline";
    }
  })(delbtnNum);
  delbtnNum++;
}
...
var delnNum = 1;
while(1) {
  var deln = document.getElementById("deln"+delnNum);
  if(deln == null) {
    break;
  }
  deln.onclick = (function(i) {
    return function() {
      var delyn = document.getElementById("delyn"+i);
      delyn.style.display = "none";
    }
  })(delnNum);
  delnNum++;
}
